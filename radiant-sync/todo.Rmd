...
- Dump On session ended stuff into Rgui and Rstudio when you hit quit. Add a function to save the 'statefile' into a location Radiant will look next time you start it up. Or add a parameter to Radiant will find it? 
...
- Download data from randerDataViewer into a new rda file! Ask Xie how you get to the index created by DataTables
