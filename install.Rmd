...
If you are asked where to install Radiant and its dependencies (i.e., "Would you like to use a personal library instead?") answer "yes" or "y"

#### 5. Create a desktop launcher

To create icons on your Desktop to start and update Radiant, copy-and-paste (or type) one of the commands below into Rstudio. For the Quantitative Analysis app use `quant`, for the Marketing Research app use `marketing`, and for the Customer Analytics app use `analytics`:
