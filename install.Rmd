...
#### 1. Install R for your system
  ...
  For windows go to <a href="https://cran.rstudio.com/bin/windows/base/" target="_blank"> https://cran.rstudio.com/bin/windows/base/</a>

#### 2. Install Rstudio

  [Rstudio for mac](https://download1.rstudio.org/RStudio-0.99.473.dmg)

  [Rstudio for windows](https://download1.rstudio.org/RStudio-0.99.473.exe)
