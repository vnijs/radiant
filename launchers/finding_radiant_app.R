...
# if(file.exists("~/Dropbox/radiant/finding_radiant_app.R")) {
#   source("~/Dropbox/radiant/finding_radiant_app.R")
# } else if(file.exists("~/../Dropbox/radiant/finding_radiant_app.R")) {
#   source("~/Dropbox/radiant/finding_radiant_app.R")
# } else {
#   cat("The app launcher could not find the right files. Ask for help.\n")
#   q("ask")
# }

if(file.exists("~/Dropbox")) {
  pth <- normalizePath("~/Dropbox")
