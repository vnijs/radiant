...
write_PACKAGES('../radiant_miniCRAN/bin/macosx/contrib/3.2/',type = 'mac.binary')
write_PACKAGES('../radiant_miniCRAN/bin/macosx/mavericks/contrib/3.2/',type = 'mac.binary')
write_PACKAGES('../radiant_miniCRAN/bin/windows/contrib/3.2/',type = 'win.binary')
